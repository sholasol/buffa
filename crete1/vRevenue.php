            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Vehicle Revenue</h4>
                    </div>
                            ...
                            <div class="contact-page-aside pl-3">
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Vehicle Report </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive"> 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $user['destination']; ?>
                                            </td>
                                            <td>
                                                <?php echo $user['created']; ?>
                                            </td>
                                            <td>
                                                <h3 align="center" title="Way Bill"><a href="Tinvoice?id=<?php echo $user['sales_id']?>" class="icon-docs"></a> </h3>
                                            </td>
                                        </tr>
                                            <?php }}?>
                                            </tbody>
