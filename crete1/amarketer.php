                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-item active" href="amarketer">Active Marketer</a></li>
                            </ol>
...
if(isset($_GET['dmarketer'])){                          
    ...
    if($dsupp){
    echo "<script> alert('Deleted');window.location='amarketer' </script>";
    }
}
if(isset($_POST['updateStaffBtn'])){
    ...
    if($sql_update){
    echo "<script> alert('Updated');window.location='amarketer' </script>";
    }
    }
}
