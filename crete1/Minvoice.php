<?php include 'header.php' ;
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $getData = dbConnect()->prepare("SELECT * FROM m_activity WHERE sales_id = ?");
        $getData->execute([$id]);
...
?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="pull-right text-right">
                                        <address>
                                            ...
                                            <p class="m-t-30"> <i class="icon icon-calendar"></i> <?php echo $date; ?></p>
                                        </address>
                                    </div>
                                </div>
                                <div class="col-md-12">
    ...
    <tbody>
        <?php
            $getItems = dbConnect()->prepare("SELECT marketing_items.product,marketing_items.quantity,marketing_items.unitPrice,pc.name FROM marketing_items JOIN product_category AS pc ON marketing_items.product = pc.id WHERE sales_id = ?");
            $getItems->execute([$id]);
            $i = 0;
