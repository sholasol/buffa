                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-item active" href="">Drivers</a></li>
                            </ol>
                            ...
                            <div class="contact-page-aside">
                                ...
                                <div class="left-aside bg-light-part">
                                    <ul class="list-style-none">
                                        <li class="box-label"><a href="<?php if($grp ==2){echo 'driver';}else{echo'javascript:void(0)';}?>">All Drivers
                                    ...
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Contacts / Drivers </h4>
                                            </div>
                                            <div class="ml-auto">
                                                <button type="button" class="btn btn-info btn-rounded m-t-10 float-right"
                                        data-toggle="modal" data-target="#add-customer">Add New Driver</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                //Student Passport
                                        ...
                                        $dbs= dbConnect()->prepare("INSERT INTO users SET fname=:fn, lname=:ln, phone=:pn, dob=:db, branch=:br, qualification=:ql, salary=:sl, email=:em, role=:rl, status=:st, joined=:jn,gender=:gn, department=:dep, image=:img, salt=:salt, password=:pwd, vehicle=:veh");
                                        ...
                                        $dbs->bindParam(':veh', $veh);

                                        if($dbs->execute()){
                                          $msg= "Driver has been added successfully!";

                                           echo  " <script>alert('$msg'); window.location='driver'</script>";
                                        }else{
...
if(isset($_GET['dmarketer'])){                          
    ...
    if($dcust){
    echo "<script> alert('Deleted');window.location='driver' </script>";
    }
}
if(isset($_POST['updateStaffBtn'])){
    ...
    if($sql_update){
    echo "<script> alert('Updated');window.location='driver' </script>";
    }
    }
}
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <select name="vehicle" class="form-control">
                                                                    ...
                                                                    <?php
                                                                    $br= dbConnect()->prepare("SELECT * FROM assets WHERE categoryid = 1");
                                                                    $br->execute();
                                                                    while($b=$br->fetch()){
                                                                    ?>  
