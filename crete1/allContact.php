                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">
                                    <a href="allcontact" class="breadcrumb-item">Contact</a></li>
                            </ol>
                            ...
                            <div class="contact-page-aside">
                                ...
                                <div class="left-aside bg-light-part">
                                    <ul class="list-style-none">
                                        <li class="box-label"><a href="<?php if($grp ==2){echo 'allcontact';}else{echo'javascript:void(0)';}?>">All Contact
                                                <span><?php echo $ast; ?></span></a></li>
                                        <li class="divider"></li>
                                        <li><a href="staff">Active <span><?php echo $acStf; ?></span></a></li>
                                        <li><a href="inactiveUser">In-Active <span><?php echo $instf; ?></span></a></li>
                                        <!-- <li><a href="suplier">Suppliers <span>623</span></a></li>
                                        <li><a href="customer">Customers <span>53</span></a></li> -->
                                        <div id="myModal" class="modal fade in">
<?php
if (isset($_POST['submit'])) {
    if (empty($fname) OR empty($lname) OR empty($email) OR empty($phone) OR empty($desg) OR empty($sex)) {
        ...
        $dbs->bindParam(':pwd', $password);
                                ...
                                if($dbs->execute()){
                                  $msg= "users has been added successfully!";
                                   ...
                                   echo  " <script>alert('$msg'); window.location='allcontact'</script>";
                                }else{
                                    $msg= "Oops! cannot add new member!";
...
if(isset($_GET['dstaff'])){                          
    ...
    if($user){
    echo "<script> alert('Deleted');window.location='allcontact' </script>";
    }
}
if(isset($_POST['updateStaffBtn'])){
    ...
    if($sql_update){
    echo "<script> alert('Updated');window.location='allcontact' </script>";
    }
    }
}
                                ...
                                <div class="right-aside ">
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">All User </h4>
                                            </div>
                                            <div class="ml-auto">
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example23"
                                            ...
                                            <tbody>
                                                <?php
                                                $mt= dbConnect()->prepare("SELECT * FROM users");
                                                $mt->execute();
                                                $i=0;
                                                while($t=$mt->fetch()){
                                                    $i++;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="label <?php if($t['department']=='Admin'){echo 'label-success';}else{echo 'label-danger';}?>"> <?php echo $t['department'];?></span> 
                                                    </td>
