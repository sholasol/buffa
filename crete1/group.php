...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['role_submit'])) {
        ...
        // in_array(needle, haystack);
            $insertRole = $connect2db->prepare("INSERT INTO role (role)VALUES(?) ");
            if ($insertRole->execute([$role])) {
                $role_id = $connect2db->lastinsertid();
                if (!empty($_POST['menu_permission']) && is_array($_POST['menu_permission'])  ) {
                    foreach ($_POST['menu_permission'] as $menu => $value) {
                      $menu_permission = $_POST['menu_permission'][$menu];
                      (!isset($menu_permission))?$menu_permission=false:$menu_permission=true;
                                  ...
                                  <ul>
                                    ...
                                    <li>
                                        ...
                                        <label class="custom-control custom-checkbox m-b-0">
                                            ...
                                            <input type="checkbox" value="<?php echo($menuid)?>"  class="custom-control-input " id="<?php echo $class; ?>" <?php $status==1 ?print("checked"):print("");?> name="menu_permission[]">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <label class="custom-control custom-checkbox m-b-0">
                                                    ...
                                                    <input type="checkbox" value="<?php echo($submenu['id'])?>" name="menu_permission[]" <?php $status==1 ?print("checked"):print("");?> class="<?php echo $class; ?> custom-control-input">
                                                ...
                                                ?>
                                                     <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="editrole?delete=<?php echo $row['id'];?>">Delete</a>
                                                        </td>
                                                     </tr>
