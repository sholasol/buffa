                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            ...
                                            <tbody>
                                            <?php
                                            $user = dbConnect()->prepare("SELECT * FROM product");
                                            $user ->execute();
                                                $i = 0;
                                            while($rw = $user->fetch()){
                                               $i++;
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $rw['standard'] ?></td>
                                            <td><span class="label label-info"><?php echo $rw['price'] ?></span> </td>
                                            <td><span class="label label-primary"><?php echo $rw['cost'] ?></span> </td>
                                            <td>
