                                    ...
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Employee List </h4>
                                            </div>
                                            <div class="ml-auto">
                                            </div>
                                        </div>
                                        ...
                                        <table id="example23"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href=""> <?php echo $t['fname'].' '.$t['lname'] ?></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a type="button" class="fas fa-edit text-success" data-toggle="modal" data-target="#add-contact" ></a>
                                                        <a href="?dstaff=<?php echo ($t['id']);?>" class="fas fa-trash text-danger"></a>
                                                        <a href="?vstaff=<?php echo ($t['id']);?>" class="fas fa-eye text-danger"></a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
