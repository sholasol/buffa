<?php include 'header.php';
    ...
    if (isset($_POST['update-expenses'])) {
        ...
        if ($updExp->execute([$ename,$date,$amount,$note,$pmod,$employee,$category,$id])) {
            echo "<script> alert('Updated');window.location='expenses' </script>";
        } else{
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" class="icon icon-pencil text-success" data-toggle="modal" data-target="#update-expenses<?php echo $user['id'] ;?>"> </a>
