                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-item active" href="allcontact">Customer</a></li>
                            ...
                            <div class="contact-page-aside">
                                ...
                                <div class="left-aside bg-light-part">
                                    <ul class="list-style-none">
                                        <li class="box-label"><a href="customer">All Customer
                                                <span><?php echo $ast; ?></span></a></li>
                                        <li class="divider"></li>
                                        <li><a href="?role=key">Key Customer <span><?php echo $acStf; ?></span></a></li>
                                        <li><a href="?role=reg">Regular Customer <span><?php echo $instf; ?></span></a></li>
                                    ...
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Customers </h4>
                                            </div>
                                            <div class="ml-auto">
                                                <button type="button" class="btn btn-info btn-rounded m-t-10 float-right"
                                        data-toggle="modal" data-target="#add-customer">New Customer</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                //Student Passport
                                        ...
                                        $dbs= dbConnect()->prepare("INSERT INTO users SET fname=:fn, lname=:ln, phone=:pn, dob=:db, branch=:br,  email=:em, role=:rl, status=:st, joined=:jn,gender=:gn,  image=:img, salt=:salt, password=:pwd, rank=:rnk");
                                        ...
                                        $dbs->bindParam(':rnk', $rank);

                                        if($dbs->execute()){
                                          $msg= "The customer has been added successfully!";

                                           echo  " <script>alert('$msg'); window.location='customer'</script>";
                                        }else{
...
<form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12 m-b-20">
                            <select name="rank" class="form-control">
                                <option selected disabled value="">-- Ranking --</option>
                        ...
                        <div class="col-md-12 m-b-20">
                            <div
                                ...
                                <span><i class="ion-upload m-r-5"></i>Upload Customer
                                    Image</span>
    ...
    <?php
        $ctSql = "";
        if (!isset($_GET['role'])) {
            $ctSql = "SELECT * FROM users WHERE role='customer' ORDER BY id DESC";
        }
    $ct= dbConnect()->prepare($ctSql);
    $ct->execute();
    $i=0;
    while($t=$ct->fetch()){
        $i++;
