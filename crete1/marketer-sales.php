        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="table table-bordered table-striped">
                                        <thead>
                                            ...
                                            <tbody>
                                            <?php
                                            $user = dbConnect()->prepare("SELECT * FROM sales_activity WHERE sales_status = 0 ORDER BY id desc");
                                            $user ->execute();
                                                $i = 0;
                                               while($rw= $user->fetch()){
                                               $i++;
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            $markid = $user->marketer;
                            $getmarketer = dbConnect()->prepare("SELECT * FROM users WHERE id = ?");
                            $getmarketer->execute([$markid]);
                            $row = $getmarketer->fetch();
                ...
                ?>
                                            ...
                                            <td><?php echo date("Y-m-d", $rw['date']) ?></td>
                                            <td><a href="view-sales?id=<?php echo $sales_id?>">View</a></td>
                                        </tr>
                                            <?php }?>
                                            </tbody>
                                    </table>
