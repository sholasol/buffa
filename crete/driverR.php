            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Drivers' Performance</h4>
                    </div>
                            ...
                            <div class="contact-page-aside pl-3">
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Performance Report </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive"> 
                                        <table id="example23"
                                            ...
                                            <tbody>
                                            <?php
                                            $users = dbConnect()->prepare("SELECT sum(amount) AS amount, driver_id, driver FROM transport GROUP BY driver");
                                           $users->execute();
                                                $i = 0;
                                               while($user = $users->fetch()){
                                                  ...
                                                  // $drvr = dbConnect()->prepare("SELECT id FROM users ")
                                               $i++;
                                               ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo ($user['driver']) ?></td>
                                            <td><span class="text-info">₦ <?php echo number_format($user['amount']); ?></span> </td>
                                            <td>
                                                <h3 align="center" title="Way Bill"><a href="Dreport?id=<?php echo $user->driver_id?>" class="icon-docs"></a> </h3>
                                            </td>
                                        </tr>
                                            <?php }?>
                                            </tbody>
