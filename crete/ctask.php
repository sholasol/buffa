            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Completed Tasks</h4>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="example23" class="table m-t-30 table-hover no-wrap contact-list"
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                <?php
                                                $mt= dbConnect()->prepare("SELECT * FROM tasks WHERE status = ?");
                                                $mt->execute([2]);
                                                $i=0;
                                                while($t=$mt->fetch()){
                                                    $i++;
                                                        ...
                                                        <div class="modal-content">
                                                           ...
                                                           <input type="hidden" name="proj" value="<?php echo $user->p_id; ?>"/>
                                                            <div class="modal-body">
                                                                ...
                                                                <?php
                                                                   $diss = dbConnect()->prepare("SELECT * FROM users ");
                                                                   $diss->execute();
                                                                   while($dis = $diss->fetch()){
                                                                   ?>
                                                                <option><?php echo $dis['fname'].' '.$dis['lname'] ?></option>
                                                                   <?php } ?> 
                                                                </select>
                                                            </div>
                                                                <div class="col-md-12 m-b-20">
