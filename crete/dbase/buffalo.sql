...
--
-- Host: localhost
-- Generation Time: Jul 15, 2021 at 10:13 AM
...
INSERT INTO `assets` (`id`, `categoryid`, `adminid`, `date_added`, `purchase_date`, `name`, `serial_no`, `notes`) VALUES
(1, 1, 1, '2021-03-25', '2021-03-11', 'Nissan 504', 'IKJ-98-009', 'new vehicl'),
(2, 1, 1, '2021-06-03', '2021-12-31', 'Vehicle', '123456', 'Toyato'),
(3, 1, 1, '2021-06-04', '2021-06-04', 'Vehicle', '123456ff', 'Nissan 6 tyre');
...
(1, 1, NULL, '2000.00', NULL, 0, NULL, 'Some notes', 'Expense', 5, 0, 0, NULL, 'Cash', '2021-01-09', NULL, NULL, 0, 0, 0, 0, NULL, NULL, NULL, NULL, '2021-04-09 00:00:00', NULL, 1, 2019),
...
(4, 3, NULL, '10000.00', NULL, 0, NULL, 'rrrr', NULL, NULL, 0, 0, NULL, NULL, '2021-04-10', NULL, NULL, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 3, 2022),
...
(1, '9CK7HY3', '2', 48, 80, 4000, 28000, NULL, 1, '2021-06-09', 400, 400, NULL, 1, 0),
(2, 'KRJNXY0', '4', 48, 3, 3000, NULL, NULL, 1, '2021-06-10', 3, -1, NULL, 1, 0),
...
(1, 'Regular Blocks', 'Per Bag', '260'),
(2, 'Standard Blocks', 'Per Bag', '210'),
(3, 'Special Block', 'Per Bag', '160'),
(4, 'Wheel Barrow', 'Per Product', '200'),
(5, 'Grade Concrete', 'Per Bag', '450');
...
(1, 'Sand', 40000, '2', '2021-02-18', 36, '400000', 0),
...
(11, 'sharp sand', 7000, '2', '2021-06-01', 500, '3500000', 1),
...
(1, 'User', 'Admin', 'admin@admin.com', '$2y$12$Tnvj9JmdWwVlCTrpy1TIVuHRNTRlm5px/c9SsDisimZ0zZSX8C3YS', 'ªœÖ!Há¿H”$’=Í®¹ü.JÕS&ÍrÓ ‘', '08170000000', '1', 1, 1, '2020-04-02 15:59:02', NULL, '1', NULL, NULL, '458388.jpg', '1', NULL, NULL, NULL, NULL),
