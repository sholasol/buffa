                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-item active" href="amarketer">In-Active driver</a></li>
                            </ol>
                                    ...
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Contacts / marketer List </h4>
                                            </div>
                                            <!-- <div class="ml-auto">
...
if(isset($_GET['dmarketer'])){                          
    $dmarketer = $_GET['dmarketer'];
    $dsupp = dbConnect()->query("DELETE FROM users WHERE id='$dmarketer' ");
    if($dsupp){
    echo "<script> alert('Deleted');window.location='omarketer' </script>";
    }
}
if(isset($_POST['updateStaffBtn'])){
    ...
    if($sql_update){
    echo "<script> alert('Updated');window.location='omarketer' </script>";
    }
    }
}
