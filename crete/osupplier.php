                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-item active" href="asupplier">Active supplier</a></li>
                            </ol>
                            ...
                            <div class="contact-page-aside">
                                ...
                                <div class="left-aside bg-light-part">
                                    <ul class="list-style-none">
                                        <li class="box-label"><a href="<?php if($grp ==2){echo 'supplier';}else{echo'javascript:void(0)';}?>">All Supplier
                                                <span><?php echo $alss; ?></span></a></li>
                                        <li class="divider"></li>
                                        <li><a href="asupplier">Active <span><?php echo $asp; ?></span></a></li>
                                        <li><a href="osupplier">In-Active<span><?php echo $isp; ?></span></a></li>
                                    ...
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Contacts / supplier List </h4>
                                            </div>
                                            <!-- <div class="ml-auto">
                                                <button type="button" class="btn btn-info btn-rounded m-t-10 float-right"
                                        data-toggle="modal" data-target="#add-supplier">Add New Contact</button>
                                            </div> -->
                                        </div>
                                    </div>
                                <?php
if(isset($_GET['dsupplier'])){                          
    $dsupplier = $_GET['dsupplier'];
    $dsupp = dbConnect()->query("DELETE FROM users WHERE id='$dsupplier' ");
    if($dsupp){
    echo "<script> alert('Deleted');window.location='asupplier' </script>";
    }
}
if(isset($_POST['updateStaffBtn'])){
    ...
    if($sql_update){
    echo "<script> alert('Updated');window.location='asupplier' </script>";
    }
    }
}
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="?dsupplier=<?php echo ($t['id']);?>" class="fas fa-trash text-danger"  onclick="return confirm('Are you sure to delete?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to delete data"></a>
