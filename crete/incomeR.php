            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Income Report</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"><small>Overview</small></h6>
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="table table-bordered table-striped">
                                        <thead>
                                            ...
                                            <tbody>
                                            <?php
                                            $userr = dbConnect()->prepare("SELECT * FROM sales_activity ORDER BY id desc");
                                            $userr->execute();
                                            $i = 0;
                                        ...
                                        <tr>
                                           <!-- <td> <?php //  echo $i++; ?></td> -->
                                            ...
                                            <td><?php 
                                                $sid = $rw['staffid'];
                                                $gn = dbConnect()->prepare("SELECT fname,lname FROM users WHERE id = ?");
                                                $gn->execute([$sid]);
                                                $fn = $gn->fetch();

                                                echo $fn['fname']." ".$fn['lname'];
                                            ?></td>
                                            <td>
                                                <?php 
                                        ...
                                        <td width="30%">
                                            ...
                                            <!-- <td>
                                                <span align="center" title="Invoice">
                                                    <a href="invoice?id=<?php echo $sales_id?>" class="icon-docs" style="font-size:20px;"></a> 
                                                </span>

                                                <span align="center" title="Invoice">
                                                    <a href="view-sales?id=<?php echo $sales_id?>" class="icon-eye" style="font-size:20px;" ></a> 
                                                </span>

                                                <span align="center" title="Invoice">
                                                    <a href="?delete=<?php echo $sales_id?>" class="icon-trash" style="font-size:20px;"></a> 
                                                </span>
                                            </td>
                                            <td>
