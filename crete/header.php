                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?php 
                                if($profileImg !=''){
                                    echo"<img src='upload/$profileImg' width='50' height='30' class='img-circle'>";
                                }else {?>
                                
                                <img src="../assets/images/users/1.jpg" alt="user" class=""> 
                               <?php } ?>
                                <span class="hidden-md-down"><?php echo $name; ?> &nbsp;<i class="fa fa-angle-down"></i></span> 
                            </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                               ...
                               <!-- <a href="javascript:void(0)" class="dropdown-item"><i class="ti-wallet"></i> My Balance</a>
                                ...
                                <!-- text-->
                                <a href="profile" class="dropdown-item"><i class="ti-settings"></i> Account Setting</a>
                                <!-- text-->
                                <div class="dropdown-divider"></div>
                                <!-- text-->
