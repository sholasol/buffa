                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="example23" class="table m-t-30 table-hover no-wrap contact-list"
                                        ...
                                        <tbody>
                                            <?php
                                                $ct= dbConnect()->prepare("SELECT t.user_id,t.subject,t.customer,t.department,t.email,t.branch,t.note,t.file,t.status,t.created,u.id,u.fname,u.lname,u.image FROM ticket AS t INNER JOIN users AS u ON t.user_id=u.id");
                                                $ct->execute();
                                                $i=0;
                                                while($t=$ct->fetch()){
                                                    $i++;
