                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-item active" href="adriver">Active driver</a></li>
                            </ol>
                            ...
                            <div class="contact-page-aside">
                                ...
                                <div class="left-aside bg-light-part">
                                    <ul class="list-style-none">
                                        <li class="box-label"><a href="<?php if($grp ==2){echo 'driver';}else{echo'javascript:void(0)';}?>">All Driver
                                                <span><?php echo $ald; ?></span></a></li>
                                        <li class="divider"></li>
                                        <li><a href="adriver">Active <span><?php echo $add; ?></span></a></li>
                                        <li><a href="odriver">In-Active<span><?php echo $idd; ?></span></a></li>
                                    ...
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Contacts / driver List </h4>
                                            </div>
                                            <!-- <div class="ml-auto">
                                                <button type="button" class="btn btn-info btn-rounded m-t-10 float-right"
                                        data-toggle="modal" data-target="#add-driver">Add New Contact</button>
                                            </div> -->
                                        </div>
                                    </div>
                                <?php
if(isset($_GET['ddriver'])){                          
    $ddriver = $_GET['ddriver'];
    $dsupp = dbConnect()->query("DELETE FROM users WHERE id='$ddriver' ");
    if($dsupp){
    echo "<script> alert('Deleted');window.location='odriver' </script>";
    }
}
if(isset($_POST['updateStaffBtn'])){
    ...
    if($sql_update){
    echo "<script> alert('Updated');window.location='0driver' </script>";
    }
    }
}
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="?ddriver=<?php echo ($t['id']);?>" class="fas fa-trash text-danger"  onclick="return confirm('Are you sure to delete?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to delete data"></a>
