<?php include 'header.php';
    ...
    if(isset($_GET['del'])){
        $c_id = $_GET['del'];
        $del = dbConnect()->prepare("DELETE FROM product_category WHERE id = ?");
        if($del->execute([$c_id])){
            echo "<script>alert('The product category is successfully deleted')</script>";
        }
   ...
   //Edit category
    if (isset($_POST['editCat'])) {
        ...
        if (empty($pname) OR empty($mode) OR empty($amount)) {
            ...
            $ins = dbConnect()->prepare(" UPDATE product_category SET name=?, payment_mode=?, amount=? WHERE id =? ");
                if ($ins->execute([$pname,$mode,$amount, $cid])) {
                                ...
                                <div class=" ">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="" data-toggle="modal" data-target="#editCat<?php echo $i ?>" class="icon icon-pencil text-success"></a>
                                                <a href="?del=<?php echo $rw['id'] ?>" onclick="return confirm('Are you sure?')" class="icon icon-trash text-danger"></a>
                                            </td>
                                                       ...
                                                       <input type="hidden" name="id" value="<?php echo $rw['id'] ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <input type="text" name="pname"  class="form-control" value="<?php echo $rw['name'] ?>"> 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="mode" class="form-control">
                                                                    <option selected ><?php echo $rw['payment_mode'] ?></option>
                                                                    <option>Per Bag</option>
                                                                    <option>Per Product</option>
                                                                    <option>Per Linear Meter (LM)</option>
                                                                    <option>Per Square Meter (Sqm)</option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <input type="number" name="amount"  class="form-control" value="<?php echo $rw['amount']; ?>"> 
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <div class="modal-footer">
                                                            <button type="submit" name="editCat" class="btn btn-info waves-effect">Edit Category</button>
