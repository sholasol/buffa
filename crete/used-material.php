                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="table table-bordered table-striped">
                                        <thead>
                                            ...
                                            <tbody>
                                            <?php
                                            $inp = dbConnect()->query("SELECT * FROM input ORDER BY id desc");
                                            if(empty($inp)){
                                                echo 'No record in the database';
                                            }else{
                                                $i = 0;
                                               while($user = $inp->fetch()){
                                               $i++;
                                               ?>
                <tr>
                    <td><?php echo $i; ?></td>
                    ...
                    <td><?php $prd = $user['input'];
                            $prdData = dbConnect()->prepare("SELECT material FROM rawmaterial WHERE id = ?");
                        $prdData->execute([$prd]);
                        $data = $prdData->fetch()['material'];
                        echo $data;
                        ?></td>
                    <td>
                        <?php 
                    ...
                    <td>
                        ...
                        <span class="label label-info"><?php echo $user['qty'] ?></span> </td>
                    <!-- <td width="30%"></td> -->
                    </tr>
                            <?php }}?>
                            </tbody>
