                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12 m-b-20">
                            ...
                            <select name="department" class="form-control">
                                <option <?php if($t['department'] == 'Account'){echo 'selected';}?>>Account</option>
                                <option <?php if($t['department'] == 'Logistics'){echo 'selected';}?>>Logistics</option>
                                <option <?php if($t['department'] == 'Production'){echo 'selected';}?>>Production</option>
                                <option <?php if($t['department'] == 'Driver'){echo 'selected';}?>>Driver</option>
                                <option <?php if($t['department'] == 'Customer'){echo 'selected';}?>>Customer</option>
                                <option <?php if($t['department'] == 'Supplier'){echo 'selected';}?>>Supplier</option>
                            </select>
                        </div>
                        <div class="col-md-12 m-b-20">
                            <label>Branch</label>
