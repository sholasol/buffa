...
if (isset($_POST['submit'])) {
	...
	$insert = dbConnect()->prepare("INSERT INTO assets (categoryid,name,serial_no,purchase_date,adminid,date_added,notes) VALUES (?,?,?,?,?,?,?)");
    if ($insert->execute([$type,$name,$regNum,$date,$uid,$added,$desc])) {
        $msg ="Assests Successfully Created";
                                ...
                                <h4 class="card-title">Create Assests</h4>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" name="reg-num" class="form-control" required>
