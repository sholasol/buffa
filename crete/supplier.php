                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-item active" href="">Suppliers</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="contact-page-aside">
                                    ...
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Suppliers </h4>
                                            </div>
                                            <div class="ml-auto">
                                ...
                                //Student Passport
                                        ...
                                        $dbs= dbConnect()->prepare("INSERT INTO users SET fname=:fn, lname=:ln, phone=:pn, dob=:db, branch=:br,  email=:em, role=:rl, status=:st, joined=:jn,gender=:gn,  image=:img, salt=:salt, password=:pwd");
                                        ...
                                        if($dbs->execute()){
                                          $msg= "The supplier has been added successfully!";

                                           echo  " <script>alert('$msg'); window.location='supplier'</script>";
                                        }else{
...
if(isset($_GET['dmarketer'])){                          
    ...
    if($dcust){
    echo "<script> alert('Deleted');window.location='supplier' </script>";
    }
}
if(isset($_POST['updateStaffBtn'])){
    ...
    if($sql_update){
    echo "<script> alert('Updated');window.location='supplier' </script>";
    }
    }
}
                            ...
                            ?> <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example23"
                                            ...
                                            <tbody>
                                                <?php
                                                $ct= dbConnect()->prepare("SELECT * FROM users WHERE role='supplier' ORDER BY id DESC");
                                                $ct->execute();
                                                $i=0;
                                                while($t=$ct->fetch()){
                                                    $i++;
