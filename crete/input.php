...
if(isset($_GET['code'])){
    echo $cd = $_GET['code'];
    $getprod = dbConnect()->prepare("SELECT name FROM production JOIN product_category AS pc ON product = pc.id WHERE code = ?");
    $getprod->execute([$cd]);
...
<!-- Page wrapper  -->
  <!-- Page wrapper  -->
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Product Material</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <!-- <div class="right-aside "> -->
                                    <div class="right-page-header">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Product Material List Input For <?php echo $product; ?> </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="example23"
                                            ...
                                            <tbody>
                                                <?php
                                                $mt= dbConnect()->prepare("SELECT * FROM input WHERE code=?");
                                                $mt->execute([$cd]);
                                                $i=0;
                                                while($t=$mt->fetch()){
                                                    $i++;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php 
                                                        $matid = $t['input'];
                                                        $getmat = dbConnect()->prepare("SELECT material FROM rawmaterial WHERE id = ? ");
                                                        $getmat->execute([$matid]);
                                                        $row = $getmat->fetch();
                                                        $material = $row['material'];
                                                        echo $material; ?></td>
                                                    <td><?php echo $t['qty'] ?></td>
                                                    <td><?php echo number_format($t['price']) ?></td>
                                                    <td><?php echo number_format($t['cost']) ?></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
    ...
    <?php
            ...
            <center><h1>Invalid production Code</h1></center>
  <?php  }
}
